...
import { Search, MapPin, Clock, Globe, Euro, Heart, Filter, X } from 'lucide-react';
...
const locaties = [
  {
    ...
    gps_coordinaten: "52.9669Â°N, 4.7172Â°O",
    ...
    prijsindicatie: "Volwassenen â‚¬11, Senioren (65+) â‚¬10, Kinderen 4-12 jaar â‚¬9,50, 0-3 jaar gratis",
  ...
  },
  {
    ...
    gps_coordinaten: "52.9638Â°N, 4.7717Â°E",
    ...
    prijsindicatie: "Ca. â‚¬8â€“â‚¬12 p.p. (diverse tarieven)",
  ...
  },
  {
    ...
    gps_coordinaten: "52.6317Â°N, 4.7482Â°O",
    ...
    prijsindicatie: "Volwassenen â‚¬6, Kinderen (t/m 12) â‚¬2,50, 0-3 jaar gratis",
  ...
  },
  {
    ...
    prijsindicatie: "Elfendeurtjes gratis, Grachtenrondvaart â‚¬12-15 (kinderkorting)",
  ...
  },
  {
    ...
    prijsindicatie: "Ca. â‚¬8 (volw), â‚¬5 (kind); extra â‚¬4,50 p.p. voor rondvaart",
  ...
  },
  {
    ...
    gps_coordinaten: "52.8713Â°N, 4.8297Â°E",
    ...
    prijsindicatie: "0-2 jaar gratis, 3-4 jaar â‚¬12 (online), 5+ jaar â‚¬18 (online), Parkeren gratis",
  ...
  },
  {
    ...
    beschrijving: "Een enorm binnen- en buitenspeelparadijs, perfect voor regenachtige dagen met drie overdekte speelhallen (2200mÂ²) vol glijbanen en klimtoestellen. Buiten vindt u een grote speeltuin van 3,5 hectare met Europa's grootste airtrampoline van 400mÂ². Het park is overzichtelijk, zodat ouders ontspannen toezicht kunnen houden vanaf het terras.",
    prijsindicatie: "Zomerseizoen (apr-sep): Kind 2-17 jr â‚¬10,00, Volw. â‚¬3,00. Winterseizoen (okt-mrt): Kind 2-17 jr â‚¬10,00, Volw. gratis. Kind 0 jr gratis, 1 jr â‚¬5,00. Parkeren â‚¬3,00",
  ...
  },
  {
    ...
    prijsindicatie: "Online: Kinderen 3-13 jr â‚¬11,50, 2 jr â‚¬7,00, 0-1 jr gratis. Volw. (14+) â‚¬10,50. Gezinsticket (2 volw. + 2 kind.) â‚¬42,00. Kassa: duurder.",
  ...
  },
  {
    ...
    prijsindicatie: "Entree Vlindorado: â‚¬10,95. Combiticket Vlindertuin & Indoor Adventure Minigolf: â‚¬18,50. Kinderen (2-12 jr) combiticket online â‚¬15,50, volw. â‚¬17,50.",
  ...
  },
  {
    ...
    gps_coordinaten: "52.9458Â°N, 4.7694Â°E",
  ...
  },
  {
    ...
    gps_coordinaten: "52.7856Â°N, 4.7983Â°E",
    ...
    prijsindicatie: "VariÃ«rend, peuters â‚¬5,95 bij vroege binnenkomst doordeweeks",
  ...
  },
  {
    ...
    prijsindicatie: "Toegang De Helderse Vallei en Blote Voetenpad is gratis. Ontdektas Blote Voetenpad â‚¬2,50 + â‚¬5 borg. Vossen Speurtocht â‚¬1. Parkeren â‚¬1,50/uur.",
  ...
  },
  {
    ...
    prijsindicatie: "Volwassenen gratis. Kinderen â‚¬6,50 (incl. muts, opdrachtenboekje, stickervel, materialen mee naar huis). Parkeren â‚¬2,30.",
  ...
  },
  {
    ...
    beschrijving: "Kies uit de Gele route (2,5 km, kinderwagenvriendelijk) of de Bruine route (5,8 km) door het grootste natuurlijke duinmerencomplex van West-Europa. Ontdek drie vogelkijkhutten en geniet van duizenden orchideeÃ«n (mei-juli) en paarse heide (augustus). Met een speciale kinderspeurtocht en rustpunten onderweg.",
    prijsindicatie: "â‚¬2 p.p. entree (kinderen t/m 12 gratis, Natuurmonumenten-leden gratis); speurtocht meestal gratis",
  ...
  },
  {
    ...
    gps_coordinaten: "52.9056Â°N, 4.7250Â°E",
    beschrijving: "Een ambachtelijke ijssalon, bekroond als een van de beste ijssalons van Nederland. Dagelijks wordt vers ijs geproduceerd in de open ijskeuken met verse ingrediÃ«nten. Biedt lactosevrij sorbetijs en vrijwel alle smaken zijn glutenvrij. Geniet van 24 smaken vers bereid ijs, koffie, of ontspan op het terras met uitzicht op een klein speeltuintje.",
    prijsindicatie: "Bolletje â‚¬1,50-2,00, kindercoupes â‚¬3,50-5,50, grote coupes â‚¬6,50-8,50",
  ...
  },
  {
    ...
    prijsindicatie: "Hoofdgerechten ca. â‚¬17-â‚¬30, Kindermenu's ca. â‚¬7,50-â‚¬12,50, Pannenkoeken ~â‚¬6",
  ...
  },
  {
    ...
    beschrijving: "Een gezellig familierestaurant met een huiselijke sfeer en een grote buitenspeeltuin direct naast het terras. Het biedt smakelijke en betaalbare maaltijden, van satÃ© tot pasta's, en een speciaal kindermenu. Kinderen vermaken zich uitstekend in de speeltuin, terwijl volwassenen rustig natafelen. Binnen is er ook ruimte om te kleuren.",
    prijsindicatie: "Kindermenu's ca. â‚¬6,50-â‚¬12,50, Pannenkoeken ca. â‚¬10,25-â‚¬14,25, Hoofdgerechten volw. ca. â‚¬15,95-â‚¬21,95",
  ...
  },
  {
    ...
    prijsindicatie: "Kindermenu's beschikbaar, Hoofdgerechten volw. ca. â‚¬19,50-â‚¬28,50",
  ...
  },
  {
    ...
    gps_coordinaten: "52.7542Â°N, 4.8089Â°E",
    beschrijving: "Het ultieme gezinsrestaurant waar kinderen na 18:00 uur gratis toegang hebben tot een grote speeltuin (200mÂ²) en het subtropisch zwembad. Geniet van een gezellige sfeer met open haard, kinderstoelen, kleurplaten en een uitgebreid kindermenu. Ouders kunnen rustig dineren terwijl de kinderen zich vermaken.",
    prijsindicatie: "Hoofdgerechten â‚¬16-24, kindermenu â‚¬8-12",
  ...
  },
  {
    ...
    gps_coordinaten: "52.8953Â°N, 4.7276Â°E",
    beschrijving: "Een modern restaurant gevestigd in een historisch gebouw aan het zonnige Loopuytpark. Het biedt een eigentijdse keuken met verse ingrediÃ«nten en kindvriendelijke menuopties. De centrale ligging maakt het ideaal voor gezinnen, waar kinderen voor en na het eten kunnen spelen in het park.",
    prijsindicatie: "Lunch â‚¬12-18, hoofdgerechten diner â‚¬18-26, kindermenu â‚¬10-14",
    openingstijden: "Dagelijks vanaf 10:00 uur, lunch vanaf 11:30 uur, diner vanaf 17:00 uur",
    website: "www.efferestaurants.nl",
  },
  {
    categorie: "Leuke Restaurants",
    naam: "Grand CafÃ© 1909",
    adres: "Centrum Julianadorp",
    gps_coordinaten: "52.8953Â°N, 4.7276Â°E (geschat)",
    beschrijving: "Een eigenwijs gezellig grand cafÃ© dat uitblinkt in kindvriendelijkheid, met een automatische pannenkoeken-service voor kinderen (met siroop en poedersuiker). Geniet van de vriendelijke en snelle bediening en de ontspannen sfeer. Ideaal voor lunch, diner of gewoon een pannenkoek.",
    prijsindicatie: "Lunch â‚¬10-16, hoofdgerechten â‚¬16-24, kindermenu/pannenkoeken â‚¬6-10",
  ...
  },
  {
    ...
    prijsindicatie: "Hoofdgerechten â‚¬18â€“â‚¬25; kindergerecht ~â‚¬8",
    openingstijden: "Woâ€“Zo vanaf 12:00 uur (hoogseizoen dagelijks)",
  ...
  },
  {
    ...
    gps_coordinaten: "52.8956Â°N, 4.7289Â°E",
    ...
    prijsindicatie: "Jong Gouda â‚¬8-12/kg, boerenkaas â‚¬12-16/kg, kruidenkazen â‚¬14-18/kg",
  ...
  },
  {
    ...
    prijsindicatie: "Brood ca. â‚¬3,15-â‚¬3,99, Gebak ca. â‚¬3,10",
  ...
  },
  {
    ...
    prijsindicatie: "Brood ca. â‚¬3,15-â‚¬3,99, Gebak ca. â‚¬3,10",
    openingstijden: "Diâ€“Vr 08:00â€“17:00 uur, Za 08:00â€“16:00 uur, Zo/ma gesloten",
    website: "www.bakkerijdunselman.nl",
  },
  {
    categorie: "Lokale Retail",
  ...
  },
  {
    ...
    gps_coordinaten: "52.6316Â°N, 4.7482Â°E",
    ...
    prijsindicatie: "Premium kazen â‚¬15-25/kg, charcuterie â‚¬20-35/100g, borrelplanken â‚¬25-50",
  ...
  },
  {
    ...
    gps_coordinaten: "52.7854Â°N, 4.9015Â°E",
    ...
    prijsindicatie: "Rauwe melk â‚¬1,50-2,00/l, geitenkaas â‚¬14-18/kg, boeren-ijs â‚¬3-5/bakje",
  ...
  },
  {
    ...
    beschrijving: "De enige melkvee- en zorgboerderij in Den Helder biedt dagverse zuivel (melk, yoghurt), ambachtelijke kazen van eigen koeien, huisgemaakte boerenworst, scharreleieren en zelfs pindakaas. Alles komt direct van het land. U kunt de koeien in de wei zien en de alpacaâ€™s aaien. Probeer de â€œNieuwedieperâ€ kaas.",
  ...
  },
  {
    ...
    gps_coordinaten: "52.9703Â°N, 4.7644Â°E",
    ...
    prijsindicatie: "Bieren â‚¬4-6, rondleiding â‚¬8 p.p. (incl. proefglas), burgers/bistro â‚¬12-18",
  ...
  },
  {
    ...
    gps_coordinaten: "52.6297Â°N, 4.7480Â°E",
    ...
    prijsindicatie: "Bieren â‚¬5-8, rondleiding â‚¬25 (inclusief 3 bieren)",
  ...
  },
  {
    ...
    gps_coordinaten: "52.6297Â°N, 4.7480Â°E (Alkmaar centrum)",
    beschrijving: "Een microbrouwerij opgericht in 2015, die speciaalbieren met een Alkmaarse insteek brouwt, vernoemd naar het riviertje De Die. Er is geen eigen proeflokaal, maar proeverijen zijn op aanvraag mogelijk. De bieren zijn te koop in lokale cafÃ©s en winkels in Alkmaar.",
  ...
  },
  {
    ...
    prijsindicatie: "Rondleiding + proeverij â‚¬15 p.p., Bieren per glas ~â‚¬3,50",
  ...
  },
  {
    ...
    prijsindicatie: "Toegang tot De Helderse Vallei is gratis. Prijs activiteit niet direct vermeld.",
    openingstijden: "25 juli 2025",
    website: "www.deheldersevallei.nl",
  },
  {
    categorie: "Evenementen",
    naam: "Voorstelling openluchttheater: 'Hakim op zâ€™n best' (De Helderse Vallei)",
  ...
  },
  {
    ...
    prijsindicatie: "Toegang waarschijnlijk gratis. Kraamhuur â‚¬15,-.",
  ...
  },
  {
    ...
    gps_coordinaten: "52.7878Â°N, 4.7966Â°E",
  ...
  },
  {
    ...
    gps_coordinaten: "52.9605Â°N, 4.7691Â°E",
  ...
  },
  {
    ...
    gps_coordinaten: "52.9597Â°N, 4.7319Â°E",
    ...
    prijsindicatie: "â‚¬12,50 volwassenen, â‚¬10 kinderen 4-12 jaar, parkeren gratis",
    ...
    <div className="max-w-6xl mx-auto p-4 bg-gradient-to-br from-blue-50 to-indigo-100 min-h-screen">
      ...
      <div className="bg-white rounded-xl shadow-lg mb-6 p-6">
        ...
        <div className="text-sm text-gray-600">
          {filteredLocations.length} van {locaties.length} locaties gevonden
        </div>
      </div>
